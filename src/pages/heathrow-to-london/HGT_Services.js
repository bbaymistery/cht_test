...
const Services = (props) => {
    ...
    const addPointCollectPoints = (index) => {
        ...
        fetch(url, configTransfer)
            ...
            .catch((error) => {
                let message = "Churchill  hgt   Services component _addPointCollectPoints()  function catch blog  "
    ...
    useEffect(() => {
        ...
        if (populationDestinations["heathrow-london"].quotations.length > 0) {
            // gtLondon = populationDestinations["heathrow-london"]

            setFirstAdresQuotations(populationDestinations["heathrow-london"].quotations)
            //POINTS for hgttolondo
            setpickPointFirstAdress(populationDestinations["heathrow-london"].selectedPickupPoints[0])
            setdropPointFirstAdress(populationDestinations["heathrow-london"].selectedDropoffPoints[0])

            setgtsecondAdressQuotations(populationDestinations["london-heathrow"].quotations)
        }
    }, [])
    return (
        <div className="service-rate-table-wrapper clearfix">
            ...
            <div className="service-rate-table-inner-wrapper clearfix">
                ...
                <div className="service-rate-wrapper">
                    <div className="service-rate-header"><p><strong>Heathrow to London</strong></p></div>
                    {/* //!soldan ikinci Kalin sekilde all inclusive yazilan*/}
                ...
                <div className="service-rate-wrapper">
                    <div className="service-rate-header"><p><strong>London to Heathrow</strong></p></div>
                    <div className="service-rate-inner">
