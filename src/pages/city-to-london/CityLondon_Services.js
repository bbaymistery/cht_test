...
const CityLondon_Services = (props) => {
  ...
  const addPointCollectPoints = (index) => {
    ...
    fetch(url, configTransfer)
      ...
      .catch((error) => {
        let message = "Churchill  CityLondon_Services component _addPointCollectPoints()  function catch blog  "
  ...
  useEffect(() => {
    ...
    if (populationDestinations["city-london"].quotations.length > 0) {
      // gtLondon = populationDestinations["gatwick-london"]

      setFirstAdresQuotations(populationDestinations["city-london"].quotations)
      //POINTS for hgttolondo
      setpickPointFirstAdress(populationDestinations["city-london"].selectedPickupPoints[0])
      setdropPointFirstAdress(populationDestinations["city-london"].selectedDropoffPoints[0])

      setgtsecondAdressQuotations(populationDestinations["london-city"].quotations)
    }
  }, [])
  return (
    <div className="service-rate-table-wrapper clearfix">
      <div className="service-rate-table-inner-wrapper clearfix">
        ...
        <div className="service-rate-wrapper">
          <div className="service-rate-header"><p><strong>City Airport to London</strong></p></div>
        ...
        <div className="service-rate-wrapper">
          ...
          <div className="service-rate-header"><p><strong>London to City Airport</strong></p></div>
          <div className="service-rate-inner">
...
export default CityLondon_Services