...
const Luton_Services = (props) => {
  ...
  const addPointCollectPoints = (index) => {
    ...
    fetch(url, configTransfer)
      ...
      .catch((error) => {
        let message = "Churchill Luton_Services component _addPointCollectPoints()  function catch blog  "
  ...
  useEffect(() => {
    ...
    if (populationDestinations["luton-london"].quotations.length > 0) {
      // gtLondon = populationDestinations["luton-london"]

      setFirstAdresQuotations(populationDestinations["luton-london"].quotations)
      //POINTS for hgttolondo
      setpickPointFirstAdress(populationDestinations["luton-london"].selectedPickupPoints[0])
      setdropPointFirstAdress(populationDestinations["luton-london"].selectedDropoffPoints[0])

      setgtsecondAdressQuotations(populationDestinations["london-luton"].quotations)
    }
  }, [])
  return (
    <div className="service-rate-table-wrapper clearfix">
      <div className="service-rate-table-inner-wrapper clearfix">
        ...
        <div className="service-rate-wrapper">
          <div className="service-rate-header"><p><strong>Luton to London</strong></p></div>
        ...
        <div className="service-rate-wrapper">
          <div className="service-rate-header"><p><strong>London to Luton</strong></p></div>
          <div className="service-rate-inner">
